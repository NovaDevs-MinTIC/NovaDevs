        ...
        <div className='max-w-md w-full space-y-8'>
          ...
          <form className='mt-8 space-y-6'>
            ...
            <div className='rounded-md shadow-sm -space-y-px'>
              <div>
              {/* <label htmlFor="email ml-2 block text-sm text-gray-900">Usuario</label> */}
                <input
                  name='email'
                  type='email'
                  autoComplete='email'
              ...
              <div>
              {/* <label htmlFor="email ml-2 block text-sm text-gray-900">Contraseña</label> */}
                <input
                  id='password'
                  name='password'
                  type='password'
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center'>
                <label htmlFor='remember-me' className=' flex items-center ml-2 text-sm text-gray-900'>
                  <input
                    id='remember-me'
                    name='remember-me'
                    type='checkbox'
            ...
            <div>
              <button
                type='submit'
                className='group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-novablue hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
              >
                <Link to='/Home' className="text-white">Inicia sesión</Link>
              </button>
            </div>
